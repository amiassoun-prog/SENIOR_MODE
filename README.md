...
המתודה הזו אינה באה להחליף את ה-skills שכבר קיימים אצלך, אלא לנצח עליהם:
...
הפרויקט משוחרר תחת רישיון MIT. השימוש, השינוי וההפצה חופשיים לחלוטין. אם הפרויקט הזה הועיל לך, כדאי לספר ל-Vlad Ko שהוא נולד מתוך העבודה שלו.
